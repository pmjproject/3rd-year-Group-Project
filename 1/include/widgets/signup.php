...
<body>
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <h1 style="font-size:xx-large">New User Sign Up</h1>
            <img src="../../img/Hotel Logo.png" width="360px" height="130px">
        ...
        <input type="text" name="nic" placeholder="Nic No" />
				<button class="submit" name="send" value="Login">Sign Up</button><br/><br>
